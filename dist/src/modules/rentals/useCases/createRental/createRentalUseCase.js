...
var CreateRentalUseCase = /** @class */ (function () {
    ...
    CreateRentalUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var carUnavailable, rentalOpenToUser, dateNow, compare, rental;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.rentalsRepository.findOpenRentalByCar(car_id)];
                    case 1:
                        carUnavailable = _b.sent();
                        if (carUnavailable) {
                            throw new AppError_1.AppError("Car is not available");
                        }
                    ...
                    case 2:
                        ...
                        if (compare < this.minimumRentalHours) {
                            throw new AppError_1.AppError("Can't register a rental with less than " + this.minimumRentalHours + " hours return time.");
                        }
