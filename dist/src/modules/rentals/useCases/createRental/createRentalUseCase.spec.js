...
describe("Create Rental", function () {
    ...
    it("Should not be able to create a new rental if user has a currently open rental", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it("Should not be able to create a new rental if there is a currently open rental for the same car", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, rentalsRepositoryInMemory.create({
                        car_id: "121212",
    ...
    it("Should not be able to create a new rental with an invalid return time", function () { return __awaiter(void 0, void 0, void 0, function () {
        var car;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, carsRepositoryInMemory.create({
                ...
                case 1:
                    ...
                    return [4 /*yield*/, expect(createRentalUseCase.execute({
                        ...
                        })).rejects.toEqual(new AppError_1.AppError("Can't register a rental with less than " + createRentalUseCase.minimumRentalHours + " hours return time."))];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
