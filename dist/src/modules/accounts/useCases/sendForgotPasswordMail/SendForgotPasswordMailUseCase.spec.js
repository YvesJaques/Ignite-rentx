...
describe("Send Forgot Mail", function () {
    ...
    it("Should be able to send a forgot password mail to user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotPasswordMailUseCase.execute("lorvarsi@ojeuf.aw")];
                case 2:
                    _a.sent();
    ...
    it("Should not be able to send an email if user does not exist", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(sendForgotPasswordMailUseCase.execute("ejazeszep@hemveed.sh")).rejects.toEqual(new AppError_1.AppError("User does not exist!"))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it("Should be able to create a new users token", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotPasswordMailUseCase.execute("ti@jan.mp")];
                case 2:
                    _a.sent();
